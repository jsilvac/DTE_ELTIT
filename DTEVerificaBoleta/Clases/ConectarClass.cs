...
namespace SamplesDTE.Clases
{
    public class ConectarClass
    {
        ...
        //Constructor
        public ConectarClass(string xservidor, string xdatabase, string xusuario, string xpassword)
        {
            Initialize(xservidor, xdatabase, xusuario, xpassword);
        }
        public ConectarClass(string xservidor, string xdatabase, string xusuario, string xpassword, int timeout)
        {
        ...
        {
            server = xservidor;
            database = "eltit_" + xbase;
            uid = xusuarios;
            password = xpassword;
            string connectionString;
            connectionString = "SERVER=" + server + ";" + "DATABASE=" +
            database + ";" + "UID=" + uid + ";" + "PWD=" + password + ";Allow Zero Datetime=True;";
            connectionString = connectionString + "Allow User Variables=True;Respect Binary flags=false;Connect Timeout=180;";
