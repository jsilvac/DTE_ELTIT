...
namespace SchoolManagementAdmin
{
    public partial class PopBoletas : Form
    {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                if(i <= 25)
                {
                    ...
                    if (caf_39 <= Convert.ToDouble(localClass.Caf_critico_39))
                    {
                        ...
                        this.EnviarEmailFolios(lblNombreLocal.Text, localClass.IP_servidor,
                            "39", Convert.ToDouble(localClass.Caf_critico_39), caf_39, row["caja"].ToString());
                    }
                    i++;
                }
                else
        ...
        private void EnviarEmailFolios(string xLocal, string xServidor, string xTipo, double xCritico, double xCurrCaf, string xCaja)
        {
