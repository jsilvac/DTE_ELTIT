...
{
    public partial class frmIngresaTimbraje : Telerik.WinControls.UI.RadForm
    {
        Autorizacion aut;
        ...
        private void frmIngresaTimbraje_Load(object sender, EventArgs e)
        {
            ...
            TipoBoleta = "39";
            lblInformacion.Text = "EMPRESAS ELTIT - DEPARTAMENTO DE SISTEMAS | " + DateTime.Now.ToLongDateString();
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //string filePath = FuncionesClass._BASE_FOLDER_PROD + @"\caf\" + FuncionesClass.G_LOCAL + @"\";

                // filePath = filePath + string.Format("{0}_{1}_{2}.dat", (int)aut.CAF.Datos.TipoDTE,txtDesde.Text,txtHasta.Text);
                ...
                /****** REGION QUE ALMACENA EL XML EN LA BDEDATOS*/
                //CafFoliosClass folios = new CafFoliosClass(FuncionesClass.G_SERVIDOR,FuncionesClass.BASE_DTE );
                //string xfecha = FuncionesClass.GetFechaMysql(textFecha.Text);
                //folios.GrabaCaf(this._CURR_COMPANY, lbTipo.Text, xfecha, txtDesde.Text, txtHasta.Text, lbNombreArchivo.Text, xmlString);
                ...
                myCaf.GrabaCafLocalCaja(ddLlocales.Text.Substring(0, 2), lblcodigoCajaCaf.Text, lbTipo.Text, lblCafDesde.Text,
        ...
        {
            Caf myCaf = new Caf(lblServidorVentas.Text, lblRoot.Text, lblPassword.Text);
            MySqlDataReader dr = myCaf.GetCaFByLocalTodos(TipoBoleta,ddLlocales.Text.Substring(0, 2));
            double quedan = 0;
        ...
        private void gvInforme_CellClick(object sender, Telerik.WinControls.UI.GridViewCellEventArgs e)
        {
            ...
            if(gvInforme.Rows.Count > 0 )
            {
                ...
                nombrecaja = gvInforme.Rows[row].Cells[2].Value.ToString();
