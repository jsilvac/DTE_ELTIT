...
Begin VB.MDIForm Principal 
   ...
   Begin VB.Menu Mventas 
      ...
      Begin VB.Menu MVPagos 
         ...
         Visible         =   0   'False
      End
      Begin VB.Menu Retiros 
         Caption         =   "Pantalla Retiro De Dinero"
      End
      ...
      Begin VB.Menu linea 
         Caption         =   "-"
      End
      Begin VB.Menu FidelizacionInvel 
         Caption         =   "FIDELIZACION DE BOLETAS INVEL"
         Index           =   99
      End
      Begin VB.Menu FAE 
         Caption         =   "MODULO FACTURA ELECTRONICA"
         Begin VB.Menu ELEC 
         ...
         End
         Begin VB.Menu comu 
            Caption         =   "MODULO COMUNICACIONES SII"
            Begin VB.Menu comusii 
               Caption         =   "Envio D.T.E SII"
               Index           =   1
            End
            Begin VB.Menu comusii 
               Caption         =   "Envio Libros SII"
               Index           =   2
            End
            Begin VB.Menu comusii 
   ...
   Begin VB.Menu CMR2 
      ...
      Begin VB.Menu COTMP 
         ...
         End
         Begin VB.Menu COBRA 
            Caption         =   "CARTOLA DE CUENTA CORRIENTE"
            Index           =   5
         End
      End
      Begin VB.Menu PRE 
   ...
   Begin VB.Menu MInformes 
      ...
      End
      Begin VB.Menu listadoderetiros 
         Caption         =   "Listado De Retiros De Dinero"
      End
      Begin VB.Menu listadodedescuentos 
         Caption         =   "Listado De Descuentos en Caja"
      End
      Begin VB.Menu listavendedor 
         Caption         =   "Listado Detalle de Ventas Por Vendedor "
      End
   ...
   Begin VB.Menu MConfiguracion 
      ...
      Begin VB.Menu lii 
         Caption         =   "-"
      End
      Begin VB.Menu admcajas 
         Caption         =   "Administracion de Cajas"
      End
   End
...
Private Sub admcajas_Click()
titCaption = Replace(AdminCajas.Caption, "&", "")
Load AdminCajas
AdminCajas.Caption = titCaption
AdminCajas.Show vbModal
Call grabaprincipal(AdminCajas.Caption)
End Sub
...
If Index = 5 Then tmplistado99.Show: tmplistado99.Caption = COBRA(5).Caption
...
Private Sub DespachoHarinas_Click()
DespachoHarina.Show
End Sub
...
Private Sub FidelizacionInvel_Click(Index As Integer)
FidelizacionBoletasInvel.Show vbModal
End Sub
...
Private Sub listadodedescuentos_Click()
titCaption = Replace(ListadoDescuentos.Caption, "&", "")
Load ListadoDescuentos
ListadoDescuentos.Caption = titCaption
ListadoDescuentos.Show
Call grabaprincipal(ListadoDescuentos.Caption)
End Sub

Private Sub listadoderetiros_Click()
titCaption = Replace(ListadoRetiros.Caption, "&", "")
Load ListadoRetiros
ListadoRetiros.Caption = titCaption
ListadoRetiros.Show
Call grabaprincipal(ListadoRetiros.Caption)
End Sub


Private Sub listavendedor_Click()
        titCaption = Replace(listadetallevendedores.Caption, "&", "")
        Load listadetallevendedores
        listadetallevendedores.Caption = titCaption
        listadetallevendedores.Show
        Call grabaprincipal(listadetallevendedores.Caption)
End Sub
...
Private Sub Retiros_Click()
    AUTORIZASISTEMA = False
    LOGINCAJERA.Show vbModal
    If AUTORIZASISTEMA = True Then
        
        titCaption = Replace(RetirosCaja.Caption, "&", "")
        Load RetirosCaja
        RetirosCaja.Caption = titCaption
        RetirosCaja.Show
        Call grabaprincipal(RetirosCaja.Caption)
End If
