 ...
 Private Sub dato1_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            If lblLocal.Caption <> "" Then
                ...
                Call ConectarAuditoria(servidor, rubroAuditoria, usuario, password)
                SendKeys "{Tab}"
            End If
        End If
    End Sub
...
Sub Lee_negativos()
    ...
    Dim hasta1 As String
        ...
        cSql.sql = "SELECT local,tipo,fecha,numero,codigo,descripcion,glosa FROM sv_documento_detalle "
