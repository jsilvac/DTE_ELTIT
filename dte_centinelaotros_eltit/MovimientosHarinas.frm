...
Begin VB.Form MovimientosHarinas 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Movimientos de Harinas"
   ClientHeight    =   3495
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6915
   ...
   End
End
Attribute VB_Name = "MovimientosHarinas"
...
'============================================================
    ...
    Private Sub dato5_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            If leerMovimiento(m, dato1.text, dato2.text, fecha, "=", "1") = True Then
                Call structtoctrl
            Else
