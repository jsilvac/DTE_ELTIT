...
Begin VB.Form MCCreditoDirecto 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   2025
   ...
   End
End
Attribute VB_Name = "MCCreditoDirecto"
...
'==============================================================
    ...
    Private Sub dato4_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 And LTrim(dato4.text) <> "" Then
            ...
            lblTipoCliente.Caption = leerTipoCliente(dato4.text)
            If lblTipoCliente.Caption <> "" Then
                SendKeys "{Tab}"
            Else
                Call selecciona(dato4)
            End If
...
'==============================================================
    Private Sub ctrltostruct()
        cc.creditoDirecto = dato1.text
        cc.cupoDirecto = dato2.text
        cc.bloqueoDirecto = dato3.text
        cc.tipocliente = dato4.text
        cc.descuento = dato5.text
        Call grabarClienteCreditoDirecto(cc)
        Unload Me
    End Sub
'==============================================================
'PASA LOS DATOS DE LOS CONTROLES A LA ESTRUCTURA
