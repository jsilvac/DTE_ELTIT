...
'****************************************************************************
Private Sub CargaGrillaInforme(ByVal row As Integer, ByVal col As Integer, ByRef año As String)
        ...
        formatogrilla(1, 3) = "TOTAL AÑO " & año
        formatogrilla(1, 4) = "TOTAL AÑO " & (CDbl(año) - 1)
        formatogrilla(1, 5) = "% "
