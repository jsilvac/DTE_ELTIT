...
End Sub
 ...
 Private Sub CargaGrillaGRID1(ByVal row As Integer, ByVal col As Integer)
       ...
       Rem DATOS DE LA COLUMNA
        ...
        formatogrilla(1, 10) = "EVENTO - GLOSA"
...
Sub LEErclientes()
       ...
       GRID1.AutoRedraw = False
        ...
        If mora <> 0 Then
            ...
            If GRID1.Cell(GRID1.Rows - 1, 9).text <> "" Then
                GRID1.Cell(GRID1.Rows - 1, 10).text = LEErultimoevento(resultado(0), FECHAMORA) & " - " & LEErultimoeventoglosa(resultado(0), FECHAMORA)
            End If
...
Rem tmpgestion.OSTMP.rut2.text = Mid(GRID1.Cell(GRID1.ActiveCell.row, 1).text, 1, 9)
...
If GRID1.Cell(GRID1.ActiveCell.row, 1).text <> "" Then
    With tmpgestion
        .lblrut.Caption = Format(Mid(GRID1.Cell(GRID1.ActiveCell.row, 1).text, 1, 9), "###,###,###") & "-" & Mid(GRID1.Cell(GRID1.ActiveCell.row, 1).text, 10, 1)
        .lblnombre.Caption = GRID1.Cell(GRID1.ActiveCell.row, 2).text
        .lblfecha.Caption = Format(fechasistema, "dd-mm-yyyy")
        .lblfechamoroso.Caption = GRID1.Cell(GRID1.ActiveCell.row, 8).text
        .lblmonto.Caption = GRID1.Cell(GRID1.ActiveCell.row, 6).text
 ...
 Private Sub CargaGrillacobranza(ByVal row As Integer, ByVal col As Integer)
       ...
       Rem DATOS DE LA COLUMNA
        ...
        For i = 1 To col - 1
            ...
            Grid2.Column(i).Width = Val(formatogrilla(8, i)) * (GRID1.Cell(0, i).Font.Size)
