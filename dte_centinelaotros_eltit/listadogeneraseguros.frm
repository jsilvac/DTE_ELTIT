...
End Sub
 ...
 Private Sub CargaGrillaGRID1(ByVal row As Integer, ByVal col As Integer)
       ...
       Rem DATOS DE LA COLUMNA
        ...
        formatogrilla(1, 7) = "FECHA INGRESO"
...
Sub LEErclientes()
        ...
        If cSql.RowsAffected > 0 Then
            ...
            While Not resultado.EOF
                ...
                Grid1.Cell(Grid1.Rows - 1, 7).text = Format(leerfechaingreso(resultado(0)), "dd-mm-yyyy")
...
Function leerfechaingreso(rut) As String
    Dim cSql As New rdoQuery
    Dim resultados As rdoResultset
    Set cSql.ActiveConnection = ventas
    cSql.sql = "select fechaingreso  from sv_maestroclientes_personales where rut='" & rut & "' "
    cSql.Execute
    leerfechaingreso = "00-00-0000"
    If cSql.RowsAffected > 0 Then
        Set resultados = cSql.OpenResultset
        If IsNull(resultados(0)) = False Then
        leerfechaingreso = resultados(0)
        End If
    End If
    cSql.Close
    Set cSql = Nothing
