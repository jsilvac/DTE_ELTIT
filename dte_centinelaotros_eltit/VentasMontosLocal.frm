...
Begin VB.Form VentasMontosLocal 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Resumen de Ventas por Montos por Local"
   ClientHeight    =   8385
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15270
   ...
   End
End
Attribute VB_Name = "VentasMontosLocal"
...
'============================================================
    ...
    Private Sub dato7_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            SendKeys "{Tab}"
            Call generaInformeVML(data, impresion, tipo, detalle, dato1.text, fecha1, fecha2)
        End If
    End Sub
    '========================================================
    'KeyPress
...
'****************************************************************************
    Private Sub CargaGrillaInforme(ByVal row As Integer, ByVal col As Integer)
        ...
        formatoGrilla(1, 3) = "P.P."
        formatoGrilla(1, 4) = "         "
        formatoGrilla(1, 5) = "CANTIDAD"
        formatoGrilla(1, 6) = "SUBTOTAL"
        formatoGrilla(1, 7) = "DESCUENTO"
        formatoGrilla(1, 8) = "NETO"
        formatoGrilla(1, 9) = "IVA"
        formatoGrilla(1, 10) = "IHA"
