...
'============================================================
    ...
    Private Sub dato1_GotFocus()
        ...
        Principal.barraEstado.Panels(2).text = "F2: Ayuda Zona"
    End Sub
    ...
    Private Sub dato1_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            If leerZona(Z, dato1.text, "=") = True Then
                Call structtoctrl
            Else
...
'=============================================================================
    ...
    Private Sub retorno()
        Call LimpiarCajas(MZonas)
        Call LimpiarLabels(MZonas)
        modifica = False
        Call DeshabilitarCajas(Me)
        dato1.SetFocus
    End Sub
