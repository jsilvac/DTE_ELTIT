...
'============================================================
    ...
    Private Sub dato0_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            lblDocumento.Caption = leerNombreDocumento(dato0.text)
    ...
    Private Sub dato1_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            If leerDocManual(D, dato0.text, dato1.text, "=") = True Then
                Call structtoctrl
                opciones.SetFocus
            Else
                If leerVenta(v, dato0.text, dato1.text, "=") = True Then
                    Call structtoctrlNormal
                Else
...
'=============================================================================
    Private Sub ctrltostruct()
        D.tipo = dato0.text
        D.numero = dato1.text
        D.fEmision = dato4.text & "-" & dato3.text & "-" & dato2.text
        D.fVencimiento = dato7.text & "-" & dato6.text & "-" & dato5.text
        D.rut = dato8.text & lblDVC.Caption
        D.sucursal = dato9.text
        D.cajera = dato10.text
        If dato0.text = "NV" Then
            D.MONTO = -1 * dato11.text
            D.abono = -1 * dato12.text
        Else
            D.MONTO = dato11.text
            D.abono = dato12.text
        End If
...
'=============================================================================
    Private Sub structtoctrl()
        ...
        dato0.text = D.tipo
        dato1.text = D.numero
        dato2.text = Format(D.fEmision, "dd")
        dato3.text = Format(D.fEmision, "mm")
        dato4.text = Format(D.fEmision, "yyyy")
        dato5.text = Format(D.fVencimiento, "dd")
        dato6.text = Format(D.fVencimiento, "mm")
        dato7.text = Format(D.fVencimiento, "yyyy")
        dato8.text = D.rut
        dato9.text = D.sucursal
        dato10.text = D.cajera
        If D.tipo = "NV" Then
            dato11.text = -1 * D.MONTO
            dato12.text = -1 * D.abono
        Else
            dato11.text = D.MONTO
            dato12.text = D.abono
        End If
    ...
    Private Sub structtoctrlNormal()
        Dim cad As String
        dato0.text = v.cabeza.tipo
        dato1.text = v.cabeza.numero
        dato2.text = Format(v.cabeza.fecha, "dd")
        dato3.text = Format(v.cabeza.fecha, "mm")
        dato4.text = Format(v.cabeza.fecha, "yyyy")
        dato5.text = Format(v.cabeza.VENCIMIENTO, "dd")
        dato6.text = Format(v.cabeza.VENCIMIENTO, "mm")
        dato7.text = Format(v.cabeza.VENCIMIENTO, "yyyy")
        dato8.text = v.cabeza.rut
        dato9.text = v.cabeza.sucursal
        dato10.text = v.cabeza.cajera
        If D.tipo = "NV" Then
            dato11.text = -1 * v.cabeza.total
            dato12.text = -1 * v.cabeza.abono
        Else
            dato11.text = v.cabeza.total
            dato12.text = v.cabeza.abono
        End If
        dato13.text = "DOCUMENTO NO ES CREDITO"
        Call dato8_KeyPress(13)
        Call dato9_KeyPress(13)
        Call dato10_KeyPress(13)
        Call DeshabilitarCajas(Me)
...
'=============================================================================
    ...
    Private Sub eliminar()
        Call eliminarDocManual(D.tipo, D.numero)
        Call retorno
        Call HabilitarCajas(Me, modifica)
        dato1.SetFocus
    End Sub
