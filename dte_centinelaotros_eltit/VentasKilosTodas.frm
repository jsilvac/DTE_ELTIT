...
Begin VB.Form VentasKilosTodas 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Estadisticas de Ventas por Kilos"
   ClientHeight    =   8385
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15270
   ...
   End
End
Attribute VB_Name = "VentasKilosTodas"
...
'============================================================
    ...
    Private Sub dato6_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            SendKeys "{Tab}"
            Call generaInformeVK(data, impresion, TIPO, detalle, dato1.text, fecha1, fecha2)
        End If
    End Sub
    '========================================================
    'KeyPress
...
'****************************************************************************
    ...
    Private Sub leerEmpresas()
        ...
        Else
            ...
            ReDim cabezaLocales(8, cantLocales + 3) As String
        End If
    End Sub
