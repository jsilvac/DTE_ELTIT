...
Begin VB.Form tmplistado13 
   ...
   End
End
Attribute VB_Name = "tmplistado13"
...
Sub LEErCREDITOS()
        ...
        cSql.sql = cSql.sql & "WHERE cd.rut=mc.rut and cd.fechacompra between '" + fecha1 + "' and '" + fecha2 + "' and cd.tipo='VR' "
