...
Private Sub leerauditoria()
        ...
        tabla = "SELECT usuario,fecha,hora,evento,programa,glosa,solicitado,basedatos,tabla,campos,datosoriginales,datosmodificados "
...
Private Sub DESDE1_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 And DESDE1.text <> "" Then DESDE1.text = ceros(DESDE1): DESDE2.SetFocus
End Sub
...
Private Sub DESDE2_KeyPress(KeyAscii As Integer)
    KeyAscii = esNumero(KeyAscii)
    If KeyAscii = 13 And DESDE2.text <> "" Then DESDE2.text = ceros(DESDE2): DESDE3.SetFocus
End Sub
...
Private Sub DESDE3_KeyPress(KeyAscii As Integer)
    KeyAscii = esNumero(KeyAscii)
    If KeyAscii = 13 And DESDE3.text <> "" Then DESDE3.text = ceros(DESDE3): HASTA1.SetFocus
End Sub
...
Private Sub HASTA1_KeyPress(KeyAscii As Integer)
    KeyAscii = esNumero(KeyAscii)
    If KeyAscii = 13 And HASTA1.text <> "" Then HASTA1.text = ceros(HASTA1): HASTA2.SetFocus
End Sub
...
Private Sub hasta2_KeyPress(KeyAscii As Integer)
    KeyAscii = esNumero(KeyAscii)
    If KeyAscii = 13 And HASTA2.text <> "" Then HASTA2.text = ceros(HASTA2): HASTA3.SetFocus
End Sub
...
Private Sub hasta3_KeyPress(KeyAscii As Integer)
    KeyAscii = esNumero(KeyAscii)
    If KeyAscii = 13 And HASTA3.text <> "" Then HASTA3.text = ceros(HASTA3): Command1.SetFocus
End Sub
