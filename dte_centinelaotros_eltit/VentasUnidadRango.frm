...
Begin VB.Form VentasUnidadRango 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Resumen de Ventas por Unidad por Rango"
   ClientHeight    =   8385
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15270
   ...
   End
End
Attribute VB_Name = "VentasUnidadRango"
...
'============================================================
    ...
    Private Sub dato6_KeyPress(KeyAscii As Integer)
        ...
        If KeyAscii = 13 Then
            ...
            SendKeys "{Tab}"
            Call generaInformeVUR(data, impresion, TIPO, detalle, dato1.text, fecha1, fecha2)
        End If
    End Sub
    '========================================================
    'KeyPress
...
'****************************************************************************
    Private Sub CargaGrillaInforme(ByVal row As Integer, ByVal col As Integer)
        ...
        impresion.Cols = col + data.Recordset.RecordCount
        impresion.Rows = row
...
'****************************************************************************
    ...
    Private Sub opt1_Click()
        If opt1.Value = True Then
            TIPO = "(dd.tipo = 'FV' OR dd.tipo = 'FE' OR dd.tipo = 'NV' OR dd.tipo = 'FE')"
            Call generaInformeVUR(data, impresion, TIPO, detalle, dato1.text, fecha1, fecha2)
        End If
    End Sub
    ...
    Private Sub leerEmpresas()
        ...
        Else
            ...
            ReDim cabezaLocales(3, cantLocales + 3) As String
        End If
    End Sub
    ...
    Private Sub impresion_Click()
        ...
        Else
            ...
            If fila = -1 Then
                fila = 0
            Else
                For i = 3 To impresion.Cols - 1
                    If impresion.Cell(fila, i).text <> "" Then
                        If IsNumeric(impresion.Cell(fila, i).text) = False Then
                            fila = 0
                            Exit For
                        End If
                    Else
                ...
                If fila1 <> 0 Then
                    ...
                    Unload VentasUnidadRangoGrafico
                    Load VentasUnidadRangoGrafico
                    With VentasUnidadRangoGrafico
                        ancho = .Width
                        alto = .Height
