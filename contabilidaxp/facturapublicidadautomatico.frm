...
For n = 1 To Grid1.Rows - 1
        ...
        If total < 1 Then GoTo no
            ...
            condicion = "tipo='" & cuentapublicidad & "' and rut='" & rut_proveedor & "' and año='" & Format(fechasistema, "yyyy") & "'"
            op = 5
...
csql.sql = "SELECT fc.rut,ifnull((select nombre from cuentascorrientes as cc where cc.rut=fc.rut and año='" + Format(fechasistema, "yyyy") + "' and tipo='23100026'),'** no creado **') as nombre,"
...
csql.sql = csql.sql + "ifnull((select noaporta from cuentascorrientes as cc where cc.rut=fc.rut and año='" + Format(fechasistema, "yyyy") + "' and tipo='23100026'),'0') as noaporta "
