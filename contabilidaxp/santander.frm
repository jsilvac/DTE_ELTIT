...
Else
    MsgBox "CUENTA NO EXISTE POR FAVOR REVISAR", vbCritical, "ATENCION"
    dato1.SetFocus
 End If
        ...
        Set resultados = csql.OpenResultset
         ...
         While Not resultados.EOF
             ...
             If Option1.Value = True And Check1.Value = 0 Then
                    ...
                    If LEERcuentacontable2(resultados(4), resultados(5), dato1.text & dato2.text & dato3.text) <> "" Then
                              Grid1.Cell(LINEA, 14).text = LEERcuentacontable2(resultados(4), resultados(5), dato1.text & dato2.text & dato3.text)
...
Sub grabarcomprobante_lineas(tipo, numero, LINEA, fecha, codigocuenta, tipoctacte, rutctacte, centrocosto, glosacontable, tipodocumento, numerodocumento, fechadocumento, fechavencimiento, monto, DH, creadopor, MES, año, fechacreacion, horacreacion, rutproveedor)
    ...
    If codigocuenta = "23100026" And rutctacte = "" Then
    rutctacte = "097036000K"
    End If
...
End Function
Public Function LEERcuentacontable2(codigo, glosa, banco) As String
    ...
    Set resultados = csql.OpenResultset
        ...
        If codigo = "00943" Then
            ...
            End If
        End If
        If banco = "11120002" Then
            If LEERcuentacontable2 = "11500100" Then LEERcuentacontable2 = "11500101"
            If LEERcuentacontable2 = "11500110" Then LEERcuentacontable2 = "11500111"
            If LEERcuentacontable2 = "11500120" Then LEERcuentacontable2 = "11500121"
            If LEERcuentacontable2 = "11500130" Then LEERcuentacontable2 = "11500131"
            If LEERcuentacontable2 = "11500140" Then LEERcuentacontable2 = "11500141"
            If LEERcuentacontable2 = "11500150" Then LEERcuentacontable2 = "11500151"
            If LEERcuentacontable2 = "11500160" Then LEERcuentacontable2 = "11500161"
            If LEERcuentacontable2 = "11500170" Then LEERcuentacontable2 = "11500171"
            If LEERcuentacontable2 = "11500180" Then LEERcuentacontable2 = "11500181"
        End If
