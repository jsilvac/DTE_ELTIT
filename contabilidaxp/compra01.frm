...
Private Sub Check1_Click()
    ...
    For k = 1 To Grid1.Rows - 1
        Grid1.Cell(k, 1).text = Check1.Value
    Next k
End Sub
...
mesn = MES + 1
añon = año
If mesn = 13 Then añon = añon + 1: mesn = 1
For k = 1 To Grid1.Rows - 1
If Grid1.Cell(k, 1).text = "1" And Grid1.Cell(k, 2).BackColor <> vbGreen Then

Call modificamesfactura(Grid1.Cell(k, 2).text, Grid1.Cell(k, 3).text, Grid1.Cell(k, 5).text, MES, año, Format(mesn, "00"), añon)
End If
    ...
    tipoprove = CUENTAPROVEEDOR
        ...
        lin = 0
         While Not resultados.EOF
                ...
                If ESTAENSII(resultados(1), resultados(2), resultados(4), resultados(11), empresaactiva, MES, año) = True Then
                     GoTo PASO:
            ...
            Grid1.Cell(lin, 5).text = Mid(resultados(4), 1, 9) + "-" + Mid(resultados(4), 10, 1)
             ...
             EXENTO = resultados(8) - refrescos - licores - vinos - cerveza - HARINA - CARNE - noazucar
                     ...
                     If ESTAENSII(resultados(1), resultados(2), resultados(4), resultados(11), empresaactiva, MES, año) = True Then
                         ...
                         If estanoaceptado = True Then
                         Grid1.Range(lin, 1, lin, Grid1.Cols - 1).BackColor = vbYellow
...
Sub ArchivoDocManuales()
    ...
    Close 20
    ARCHIVO = "u:\LIBROS\Doc_manuales_" + año & "-" & MES + ".csv"
...
Sub modificamesfactura(tipo, numero, rut, mesc, anoc, mesn, anon)
    ...
    If tipo = "FA" Then tipo = "1": tipo2 = "FC"
    If tipo = "ND" Then tipo = "2": tipo2 = "DC"
    If tipo = "NC" Then tipo = "3": tipo2 = "NC"
    If tipo = "FAE" Then tipo = "4": tipo2 = "FC"
    If tipo = "NDE" Then tipo = "5": tipo2 = "DC"
    If tipo = "NCE" Then tipo = "6": tipo2 = "NC"
    If tipo = "FC" Then tipo = "7": tipo2 = "FP"
    If tipo = "IM" Then tipo = "8": tipo2 = "IM"
    If tipo = "FE" Then tipo = "9": tipo2 = "EN"
    If tipo = "FEE" Then tipo = "0": tipo2 = "EE"
