...
Dim infogrilla As grilla1847
Set infogrilla = New grilla1847
...
End Sub
    ...
    Sub DIFERENCIA(infogrilla As grilla1847, row)
    ...
    Next k
    End Sub
    Sub totales(infogrilla As grilla1847, row)
    Dim DIFE As Double
...
Sub CARGAGRILLA(infogrilla As grilla1847)
...
Sub CARGABALANCE(infogrilla As grilla1847)
    Dim resultados As rdoResultset
    Dim csql As New rdoQuery
    Dim rut As String
    Dim lin As Double
    Dim RESUMEN(20, 3) As Variant
        Set csql.ActiveConnection = contadb
        csql.sql = "SELECT codigo,f_1847,nombre,tipo "
