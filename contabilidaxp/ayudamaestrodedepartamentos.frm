...
Begin VB.Form ayudamaestrodedepartamentos 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda Maestro de Departamentos"
   ClientHeight    =   6780
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8220
   DrawStyle       =   5  'Transparent
   LinkTopic       =   "Ayuda Maestro de Departamentos"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   452
   ScaleMode       =   3  'Pixel
   ...
   Begin MSAdodcLib.Adodc mdepartamentos 
      Height          =   330
      Left            =   480
      Top             =   5400
      Visible         =   0   'False
   ...
   Begin VB.Frame datospersonales 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "ayudamaestrodedepartamentos.frx":0000
         Height          =   4935
         Left            =   240
         TabIndex        =   2
         Top             =   600
      ...
      Begin VB.Label Label1 
         BackStyle       =   0  'Transparent
         Caption         =   "Buscar por Nombre de Departamento"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ayudamaestrodedepartamentos"
...
With ayudamaestrodedepartamentos
        .mdepartamentos.ConnectionString = "driver={MySQL ODBC 3.51 Driver};" & _
        "server=localhost;uid=root;pwd=;database=conta01"
        .mdepartamentos.RecordSource = "SELECT codigodepa, nombre FROM maestrodepartamentos WHERE nombre >= '" & buscaproductos.text & "' ORDER BY nombre"
        .mdepartamentos.Refresh
    End With
    ' <>
