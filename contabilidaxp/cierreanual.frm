...
Sub blanqueamayor()
    ...
    Dim cSql3 As New rdoQuery
       ...
       Set cSql3.ActiveConnection = contadb
        cSql3.sql = "update saldosdelmayor set debeanterior='0',haberanterior='0' "
        cSql3.sql = cSql3.sql + " where  año='" + AÑOSIGUIENTE + "' "
        cSql3.Execute
...
Sub blanqueactacte()
    ...
    Dim cSql3 As New rdoQuery
       ...
       Set cSql3.ActiveConnection = contadb
        cSql3.sql = "update saldosctacte set debeanterior='0',haberanterior='0' "
        cSql3.sql = cSql3.sql + " where  año='" + AÑOSIGUIENTE + "' "
        cSql3.Execute
        Call sincronizadatos(cSql3.sql, contadb, "")
...
Sub creamayor()
    ...
    Dim cSql3 As New rdoQuery
        ...
        csql2.sql = "INSERT INTO " + clientesistema + "conta" + empresaactiva + ".cuentasdelmayor (codigo,año,nombre,tipo,ctacte,crcc,banco,ila,ica,iha,activo,f_1846,f_1847,prorro,plansii,f_1829,f_1847_2016,patrimonio) "
        csql2.sql = csql2.sql + " SELECT codigo,'" + AÑOSIGUIENTE + "',nombre,tipo,ctacte,crcc,banco,ila,ica,iha,activo,f_1846,f_1847,prorro,plansii,f_1829,f_1847_2016,patrimonio "
       ...
       Set cSql3.ActiveConnection = contadb
        cSql3.sql = "INSERT INTO " + clientesistema + "conta" + empresaactiva + ".saldosdelmayor (codigo,año) "
        cSql3.sql = cSql3.sql + " SELECT codigo,'" + AÑOSIGUIENTE + "' "
        cSql3.sql = cSql3.sql + "FROM " + clientesistema + "conta" + empresaactiva + ".saldosdelmayor where año='" + Format(fechasistema, "yyyy") + "' "
