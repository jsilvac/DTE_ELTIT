...
Begin VB.Form presu00 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Maestro de Centros de Gastos"
   ClientHeight    =   7380
   ClientLeft      =   2040
   ClientTop       =   1305
   ClientWidth     =   6285
...
dato1.text = Grid1.Cell(Grid1.ActiveCell.row, 1).text
...
Call CARGAGRILLAtiponombre(Me, Grid1)
...
Sub leer()
    ...
    campos(2, 0) = ""
    campos(0, 2) = clientesistema & "conta" & ".presupuesto_centros"
