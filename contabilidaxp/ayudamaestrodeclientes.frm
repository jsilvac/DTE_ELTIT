...
Begin VB.Form ayudamaestrodeclientes 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda Maestro de Clientes"
   ClientHeight    =   7020
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9435
   ...
   Begin MSAdodcLib.Adodc mclient 
      Height          =   375
      Left            =   600
      Top             =   5400
      Visible         =   0   'False
   ...
   Begin VB.Frame datospersonales 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "ayudamaestrodeclientes.frx":0000
         Height          =   4935
         Left            =   240
         TabIndex        =   2
         Top             =   600
   ...
   End
End
Attribute VB_Name = "ayudamaestrodeclientes"
...
With ayudamaestrodeclientes
        .mclient.ConnectionString = "driver={MySQL ODBC 3.51 Driver};" & _
        "server=localhost;uid=root;pwd=;database=conta01"
        .mclient.RecordSource = "SELECT rutcliente, nombre FROM maestroclientes WHERE nombre >= '" & buscaproductos.text & "' ORDER BY nombre"
        .mclient.Refresh
    End With
    ' <>
