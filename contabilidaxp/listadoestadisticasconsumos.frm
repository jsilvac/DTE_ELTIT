...
Sub Titulos()
    ...
    objReportTitle.text = "LISTADO DE CONSUMOS Y ESTADISTICAS"
...
Sub CARGAGRILLA2()
    ...
    formatogrilla2(1, 5) = "UBICACION"
    formatogrilla2(1, 6) = "ENERO"
    formatogrilla2(1, 7) = "FEBRERO"
    formatogrilla2(1, 8) = "MARZO"
    formatogrilla2(1, 9) = "ABRIL"
    formatogrilla2(1, 10) = "MAYO"
    formatogrilla2(1, 11) = "JUNIO"
    formatogrilla2(1, 12) = "JULIO"
    formatogrilla2(1, 13) = "AGOSTO"
    formatogrilla2(1, 14) = "SEPTIEMBRE"
    formatogrilla2(1, 15) = "OCTUBRE"
    formatogrilla2(1, 16) = "NOVIEMBRE"
    formatogrilla2(1, 17) = "DICIEMBRE"
    
    Rem LARGO DE LOS DATOS
    formatogrilla2(2, 1) = "5"
    formatogrilla2(2, 2) = "7"
    formatogrilla2(2, 3) = "0"
    formatogrilla2(2, 4) = "0"
    formatogrilla2(2, 5) = "20"
    formatogrilla2(2, 6) = "6"
    formatogrilla2(2, 7) = "7"
    formatogrilla2(2, 8) = "7"
    formatogrilla2(2, 9) = "7"
    formatogrilla2(2, 10) = "7"
    formatogrilla2(2, 11) = "7"
    formatogrilla2(2, 12) = "7"
    formatogrilla2(2, 13) = "7"
    formatogrilla2(2, 14) = "7"
    formatogrilla2(2, 15) = "7"
    formatogrilla2(2, 16) = "7"
    formatogrilla2(2, 17) = "7"
...
CARGAGRILLA2
 ...
 If csql.RowsAffected > 0 Then
    ...
    Grid2.Cell(Grid2.Rows - 1, 5).text = resultados(6)
...
mesa = Format(COMBOMES.ListIndex + 1, "00")
 Set csql.ActiveConnection = contadb
 csql.sql = "select SUM(montodocumento),rut,mid(fecha,6,2) from " & clientesistema & "consumos_basicos.detalle_servicios "
 csql.sql = csql.sql + "where tipo='" + tipo + "' and numeroservicio='" + numero + "' "
 csql.sql = csql.sql + "and mid(fecha,1,4)='" + COMBOAÑO.text + "' GROUP BY mid(fecha,1,7)"
 
 csql.Execute
 If csql.RowsAffected > 0 Then
    Set resultados = csql.OpenResultset
    While resultados.EOF = False
    Grid2.Cell(Grid2.Rows - 1, 3).text = leerProveedor(resultados(1))
    
    Grid2.Cell(Grid2.Rows - 1, 5 + resultados(2)).text = Format(resultados(0), "###,###,###")
