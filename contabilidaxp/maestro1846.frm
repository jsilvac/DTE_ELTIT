...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
       totales = 0
        ...
        csql2.sql = csql2.sql + "FROM sii_1846 "
...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
        Set csql2.ActiveConnection = contadb
        csql2.sql = "SELECT codigo,nombre,f_1846 "
...
Private Sub Grid1_Click()
 If Grid2.Selection.FirstRow > 0 Then
        For k = Grid2.Selection.FirstRow To Grid2.Selection.LastRow
            ...
            Call modifica_mayor(Grid2.Cell(k, 1).text, Grid2.Cell(k, 3).text, "f_1846")
