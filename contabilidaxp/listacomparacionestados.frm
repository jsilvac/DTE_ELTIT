...
infogrilla.Caption = "ESTADO DE RESULTADOS ": grillainformes.Tag = "PRESU04"
...
Dim resultados As rdoResultset
    ...
    tip = "1"
        ...
        csql.sql = "SELECT codigo,nombre,sum(enero),sum(febrero),sum(marzo),sum(abril),sum(mayo),sum(junio),sum(julio),sum(agosto),sum(septiembre),sum(octubre),sum(noviembre),sum(diciembre) from estadoresultado group by año,codigo "
         csql.Execute
...
Dim resultados As rdoResultset
    ...
    tip = "1"
        ...
        csql.sql = csql.sql + "where cm.codigo=sm.cuenta and sm.año='" + Format(fechasistema, "yyyy") + "' and mid(cm.codigo,1,1)>'2' and sm.codigo='" + CRCC + "' "
...
Dim MES As String
        ...
        csql.sql = csql.sql + "where cm.codigo=sm.codigo and sm.año='" + Format(fechasistema, "yyyy") + "' and mid(sm.codigo,1,1)>'2' and cm.año='" + Format(fechasistema, "yyyy") + "' "
        If datos2.Value = True Then
        csql.sql = csql.sql + "and mid(sm.codigo,5,4)='0000' and mid(sm.codigo,3,2)<>'00' "
        End If
        If datos3.Value = True Then
...
Dim MES As String
        ...
        Set csql.ActiveConnection = conta
        csql.sql = "delete from " + clientesistema + "conta.estadoresultado"
        csql.Execute
