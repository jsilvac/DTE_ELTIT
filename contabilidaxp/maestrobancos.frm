...
Sub leersiguiente()
    ...
    campos(2, 0) = ""
    campos(0, 2) = "maestrobancos"
    condicion = " codigobanco > '" & dato1.text & "' order by codigobanco asc "
...
Sub leeranterior()
    ...
    campos(2, 0) = ""
    campos(0, 2) = "maestrobancos"
    condicion = " codigobanco < '" & dato1.text & "' order by codigobanco desc "
