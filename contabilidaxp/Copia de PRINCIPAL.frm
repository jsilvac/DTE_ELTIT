...
Begin VB.MDIForm PRINCIPAL 
   ...
   Begin VB.Menu info 
      ...
      Begin VB.Menu informessii 
         ...
         End
         Begin VB.Menu infosii 
            Caption         =   "Certificado Renta F1887"
            Index           =   3
         End
         Begin VB.Menu infosii 
...
If Index = 3 Then form1887.Show
If Index = 4 Then infoharina.Show
If Index = 5 Then infocarne.Show
If Index = 6 Then infoilas.Show
If Index = 7 Then planosiva.Show
