...
Begin VB.Form ventas05 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000005&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pantalla Notas de Creditos"
   ClientHeight    =   10380
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12300
...
'******************************************************************************
    ...
    With ventas05
        .pnc.ConnectionString = "driver={MySQL ODBC 3.51 Driver};" & _
        "server=localhost;uid=root;pwd=;database=conta01"
        .pnc.RecordSource = "SELECT codigoproducto,descripcion,pventadetalle,stockcritico FROM maestroproductos WHERE descripcion >= '" & buscaproductos.text & "' ORDER BY descripcion"
        .pnc.Refresh
    End With
