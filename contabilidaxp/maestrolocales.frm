...
Private Sub dato1_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF2 Then Call ayudalocales(dato2)
...
Sub leer()
    ...
    condicion = "codigolocal=" + "'" + dato1.text + "'"
    op = 5
...
Sub leersiguiente()
    ...
    campos(0, 2) = "maestrolocales"
    condicion = "codigolocal>" + "'" + dato1.text + "' order by codigolocal"
    op = 5
    SQLUTIL.datos = campos
    Set SQLUTIL.conexion = db
    Call SQLUTIL.SQLUTIL(op, condicion)
...
Sub ayudalocales(ByRef caja As TextBox)
    ...
    campos = Array("codigolocal", "nombre")
    cfijo = Array("no")
    Call cargaAyudaT("servidor", "conta01", "root", "123", "maestrolocales", dato1, campos, cfijo, 2)
    caja.Enabled = True
    caja.SetFocus
...
Sub GRABAR()
    ...
    campos(0, 2) = "maestrolocales"
    If modifi = 1 Then condicion = "codigolocal=" + "'" + dato1.text + "'"
