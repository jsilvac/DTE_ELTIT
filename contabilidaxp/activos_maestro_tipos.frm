...
Begin VB.Form activos_maestro_tipos 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FF8080&
   ...
   Begin XPFrame.FrameXp FrmOpciones 
      ...
      Begin Contabilidadxp.BotonMyERP opcion 
         ...
         Caption         =   "Modificar"
         PicturePosition =   0
         Picture         =   "activos_maestro_tipos.frx":0000
         PictureHover    =   "activos_maestro_tipos.frx":0CB6
         Enabled         =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
      ...
      Begin Contabilidadxp.BotonMyERP opcion 
         ...
         Caption         =   "Eliminar"
         PicturePosition =   0
         Picture         =   "activos_maestro_tipos.frx":1A17
         PictureHover    =   "activos_maestro_tipos.frx":2734
         Enabled         =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
      ...
      Begin Contabilidadxp.BotonMyERP opcion 
         ...
         Caption         =   "Retorno"
         PicturePosition =   0
         Picture         =   "activos_maestro_tipos.frx":34CD
         PictureHover    =   "activos_maestro_tipos.frx":41F6
         Enabled         =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
   ...
   Begin XPFrame.FrameXp FrameXp1 
      ...
      _ExtentY        =   11880
      BackColor       =   16744576
      Caption         =   "MAESTRO DE TIPO DE ACTIVOS "
      CaptionEstilo3D =   2
      BackColor       =   16744576
      ForeColor       =   8438015
      ...
      Begin XPFrame.FrameXp FrameXp3 
         ...
         _ExtentY        =   9340
         BackColor       =   16761024
         Caption         =   "TIPO DE ACTIVOS CREADOS"
         CaptionEstilo3D =   2
         BackColor       =   16761024
         ForeColor       =   8438015
         BordeColor      =   -2147483635
   ...
   End
End
Attribute VB_Name = "activos_maestro_tipos"
...
Function leer(codigo) As Boolean
    ...
    campos(1, 0) = "nombre"
    campos(2, 0) = ""
    campos(0, 2) = "af_maestro_tipo_activos"
...
csql.sql = "select codigo,nombre from af_maestro_tipo_activos "
csql.Execute
Grid1.Rows = 1
