...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
       totales = 0
        ...
        If fechasistema < "2013-01-01" Then
        csql2.sql = csql2.sql + "FROM sii_1847 "
        Else
        csql2.sql = csql2.sql + "FROM sii_1847_2013 "
...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
        Set csql2.ActiveConnection = contadb
        csql2.sql = "SELECT codigo,nombre,f_1847 "
        csql2.sql = csql2.sql + "FROM cuentasdelmayor where año='" + AÑOCONSULTA + "' and tipo<>'8' and mid(codigo,5,4)<>'0000' "
        csql2.sql = csql2.sql + "order by codigo"
        csql2.Execute
        LINEAS = 0
...
Private Sub Grid1_Click()
 If Grid2.Selection.FirstRow > 0 Then
        For k = Grid2.Selection.FirstRow To Grid2.Selection.LastRow
            ...
            Call modifica_mayor(Grid2.Cell(k, 1).text, Grid2.Cell(k, 3).text, "f_1847")
