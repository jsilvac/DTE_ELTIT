...
Begin VB.Form revisahonorarios 
   BackColor       =   &H00FF8080&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Revisa LIBRO DE HONORARIOS"
   ClientHeight    =   8370
   ClientLeft      =   45
   ClientTop       =   1110
   ClientWidth     =   14160
   ...
   End
End
Attribute VB_Name = "revisahonorarios"
...
Sub Command1_Click()
            ...
            Dim resultados As rdoResultset
                Dim csql As New rdoQuery
                 ...
                 csql.sql = "SELECT fc.tipo,numero,fecha,fc.rut,cc.nombre,monto,retencion,liquido,fc.mescontable,fc.añocontable "
                    ...
                    Set resultados = csql.OpenResultset
                     While Not resultados.EOF
                         ...
                         dato9.text = Mid(resultados(3), 1, 9)
                         DV.Caption = Mid(resultados(3), 10, 1)
                         leefactura
                         carga
                         leecomprobante
                         GRABARCOMPROBANTE
...
Dim resultados As rdoResultset
    Dim csql As New rdoQuery
        ...
        Set csql.ActiveConnection = contadb
        csql.sql = "delete from  movimientoscontables where (TIPO='BH') "
