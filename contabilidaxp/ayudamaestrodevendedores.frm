...
Begin VB.Form ayudamaestrodevendedores 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda Maestro Vendedores"
   ClientHeight    =   7035
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9420
   ...
   Begin VB.Frame datospersonales 
      ...
      Top             =   360
      Width           =   8775
      Begin MSAdodcLib.Adodc mvendedores 
         Height          =   375
         Left            =   360
         Top             =   4320
         Visible         =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "ayudamaestrodevendedores.frx":0000
         Height          =   4935
         Left            =   120
         TabIndex        =   4
         Top             =   480
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Buscar por Nombre de Vendedor"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ayudamaestrodevendedores"
...
With ayudamaestrodevendedores
        .mvendedores.ConnectionString = "driver={MySQL ODBC 3.51 Driver};" & _
        "server=localhost;uid=root;pwd=;database=conta01"
        .mvendedores.RecordSource = "SELECT codigovendedor, nombre FROM maestrovendedores WHERE nombre >= '" & buscaproductos.text & "' ORDER BY nombre"
        .mvendedores.Refresh
    End With
    ' <>
End Sub
