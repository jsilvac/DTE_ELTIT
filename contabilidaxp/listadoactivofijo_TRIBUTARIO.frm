...
Begin VB.Form activofijotb02 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "LISTADO ACTIVO FIJO TRIBUTARIO"
   ClientHeight    =   9750
   ClientLeft      =   2040
   ClientTop       =   1305
   ClientWidth     =   15195
   ...
   End
End
Attribute VB_Name = "activofijotb02"
...
If KeyAscii = 13 Then
Call ceros(dato3)
lblnombreFAMILIA.Caption = LeerNombreFamiliaSII(dato3.text)
...
'    formatogrilla2(1, 13) = "DEPRECIACION" & vbCrLf & "DEL EJERCICIO"
    ...
    csql.sql = csql.sql & " from activo_fijo_tributario   "
