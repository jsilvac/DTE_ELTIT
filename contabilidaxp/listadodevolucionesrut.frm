...
csql.sql = "select dp.local,dp.rut,cc.nombre,dp.fecha,dp.numero,dp.monto,dp.montoco,dp.tipo "
...
csql.sql = csql.sql & "where dp.rut='" & dato3.text + dv.Caption & "' and dp.montoco='0' and local='" + localfiltro + "' "
Else
csql.sql = csql.sql & "where dp.montoco='0' and local='" + localfiltro + "' "
...
If csql.RowsAffected > 0 Then
    ...
    While Not resultados.EOF
        ...
        If guiarebajada(resultados(7), resultados(4), clientesistema + "gestion" + leerdatoslocal(resultados(0), "rubro") + ".l_ordendecompra_anexopagos_" + resultados(0)) = False Then
