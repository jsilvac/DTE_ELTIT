...
Begin VB.Form generabancocreditosplus 
   BackColor       =   &H00FFC0C0&
   ...
   Begin XPFrame.FrameXp FrameXp1 
      ...
      _ExtentY        =   14208
      BackColor       =   16773879
      Caption         =   " LISTA DE CREDITOS CARGADOS EN LIQUIDACION"
      CaptionEstilo3D =   1
      BackColor       =   16773879
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
   ...
   End
End
Attribute VB_Name = "generabancocreditosplus"
...
'        End If
 If GridLiquida.Cell(k, 9).text = "1" Then
        ...
        CUENTABANCO = "11250001"
        fechavencimiento = Format(fechasistema, "yyyy-mm-dd")
        monto = CDbl(GridLiquida.Cell(k, 8).text)
        DH = "D"
  If verificasiexiste2(rutcontable, CUENTABANCO, FECHACONTABLE, tipocontable, "CANC. CREDITO ELTIT PLUS ") = False Then

            lineacontable = lineacontable + 1
            Call grabarcomprobante_lineas(tipocontable, numerocontable, lineacontable, _
            FECHACONTABLE, CUENTABANCO, " ", rutcontable, " ", "CANC. CREDITO ELTIT PLUS " & NOMBREGIRADO, _
...
Sub CargaGridLiquida(grilla As Grid)
    ...
    If csql.RowsAffected > 0 Then
        ...
        While Not resultados.EOF
             LIQUIDO = leercreditoplus(resultados(0), Format(fechasistema, "mm"), Format(fechasistema, "YYYY"), "00039")
...
'            Call calculaliquidaciones.calculaliquidaciones(resultados(0), Format(fechasistema, "mm"), Format(fechasistema, "YYYY"), empresaactiva)
    ...
    grilla.Cell(grilla.Rows - 1, 2).text = "TOTAL CREDITOS A PAGAR X BANCO "
    ...
    grilla.Cell(grilla.Rows - 1, 2).text = "TOTAL CREDITOS A PAGAR DIRECTOS "
...
Dim DH As String
    ...
    Rem graba cheque
        ...
        DH = "H"
        NOMBREGIRADO = leerempresa("28")
        Call grabarcomprobante_lineas(tipocontable, numerocontable, lineacontable, FECHACONTABLE, CUENTABANCO, " ", "", " ", NOMBREGIRADO, tipodocumento, numerodocumento, FECHACONTABLE, fechavencimiento, monto, DH, USUARIOSISTEMA, Format(fechasistema, "mm"), Format(fechasistema, "yyyy"), Format(Date, "yyyy-mm-dd"), Time, leerRutempresa("28"))
