...
Private Sub dato1_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF2 Then Call ayudaimpuestos(dato2)
...
Sub leer()
    ...
    condicion = "codigoimpuesto=" + "'" + dato1.text + "'"
    op = 5
...
Sub leersiguiente()
    ...
    campos(0, 2) = "maestroimpuestos"
    condicion = "codigoimpuesto>" + "'" + dato1.text + "' order by codigoimpuesto"
    op = 5
    SQLUTIL.datos = campos
    Set SQLUTIL.conexion = db
    Call SQLUTIL.SQLUTIL(op, condicion)
...
Sub ayudaimpuestos(ByRef caja As TextBox)
    Dim campos As Variant
    Dim cfijo As Variant
    campos = Array("codigoimpuesto", "nombre")
    cfijo = Array("no")
    Call cargaAyudaT("servidor", "conta01", "root", "123", "maestroimpuestos", dato1, campos, cfijo, 2)
    caja.Enabled = True
    caja.SetFocus
...
Sub GRABAR()
    ...
    campos(2, 1) = dato3.text 'PORCENTAJE
        
    campos(0, 2) = "maestroimpuestos"
    If modifi = 1 Then condicion = "codigoimpuesto=" + "'" + dato1.text + "'"
