...
Begin VB.Form ayudamaestrodeproductos 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda Maestro de Productos"
   ClientHeight    =   6795
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9870
   ...
   Begin VB.Frame datospersonales 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "ayudamestrodeproductos.frx":0000
         Height          =   4935
         Left            =   360
         TabIndex        =   2
         Top             =   600
   ...
   End
End
Attribute VB_Name = "ayudamaestrodeproductos"
...
With ayudamaestrodeproductos
        .Adodc1.ConnectionString = "driver={MySQL ODBC 3.51 Driver};" & _
        "server=localhost;uid=root;pwd=;database=conta01"
        .Adodc1.RecordSource = "SELECT codigoproducto,descripcion,pventadetalle FROM maestroproductos WHERE descripcion >= '" & buscaproductos.text & "' ORDER BY descripcion"
        .Adodc1.Refresh
    End With
    ' <>
End Sub
...
'******************************************************************************
'Codigo para tomar posicion de la transparencia de imagen
'******************************************************************************
...
'******************************************************************************
'Fin Codigo para tomar posicion transparencia de imagen
'******************************************************************************
...
'******************************************************************************
    ' t$ = "<CODIGO       |<DESCRIPCION                        |>PRECIO VENTA         "
    ' lista.FormatString = t$
End Sub
