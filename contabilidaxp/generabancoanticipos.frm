...
Begin VB.Form generabancoanticipos 
   BackColor       =   &H00FFC0C0&
   ...
   End
End
Attribute VB_Name = "generabancoanticipos"
...
Sub CargaGridLiquida(grilla As Grid)
    ...
    If csql.RowsAffected > 0 Then
        ...
        While Not resultados.EOF
             LIQUIDO = leeranticipos(resultados(0), Format(fechasistema, "mm"), Format(fechasistema, "YYYY"), "00010")
