...
If Index = 1 Then activos_maestro.Show: activos_maestro.Caption = (activof(Index).Caption)
If Index = 2 Then activos_maestro_tipos.Show: activos_maestro_tipos.Caption = (activof(Index).Caption)
...
If Index = 9 Then poder_santander.Show: poder_santander.Caption = banco(Index).Caption
...
If Index = 6 Then form3500.Show: form3500.Caption = infosii(Index).Caption
If Index = 7 Then infoharina.Show: infoharina.Caption = infosii(Index).Caption
If Index = 8 Then infocarne.Show: infocarne.Caption = infosii(Index).Caption
If Index = 9 Then infoilas.Show: infoilas.Caption = infosii(Index).Caption
If Index = 10 Then planosiva.Show: planosiva.Caption = infosii(Index).Caption
...
If Index = 1 Then prove0001.Show: prove0001.Caption = prove0001(Index).Caption
If Index = 2 Then prove0003.Show: prove0003.Caption = prove0003(Index).Caption
If Index = 3 Then prove0002.Show: prove0002.Caption = prove0002(Index).Caption
If Index = 4 Then prove0004.Show: prove0004.Caption = prove0004(Index).Caption
If Index = 5 Then prove0005.Show: prove0005.Caption = prove0005(Index).Caption
If Index = 6 Then prove0006.Show: prove0006.Caption = prove0006(Index).Caption
If Index = 7 Then prove0007.Show: prove0007.Caption = prove0007(Index).Caption
If Index = 8 Then prove0008.Show: prove0008.Caption = prove0008(Index).Caption
If Index = 9 Then prove0009.Show: prove0009.Caption = prove0009(Index).Caption
If Index = 10 Then prove0010.Show: prove0010.Caption = prove0010(Index).Caption
If Index = 11 Then prove0011.Show: prove0011.Caption = prove0011(Index).Caption
If Index = 12 Then prove0012.Show: prove0012.Caption = prove0012(Index).Caption
