...
Sub CARGAGRILLADETALLE()
    ...
    formatogrilla2(1, 7) = "REBAJADA EN PAGOS "
...
tipo = "DM"
cuentapublicidad = leerdatos(conta2, "maestroempresas", "cuentapublicidad", "codigoempresa='" + empresaactiva + "' ")

Set csql.ActiveConnection = db

csql.sql = "select '',dp.rut,cc.nombre,dp.fecha,dp.numero,dp.total,dp.abono "
...
csql.sql = csql.sql & "where dp.rut='" & dato3.text + DV.Caption & "' and dp.abono='0' "
Else
csql.sql = csql.sql & "where dp.abono='0' "
...
'        If guiarebajada("DM", resultados(4), clientesistema + "gestion" + leerdatoslocal(resultados(0), "rubro") + ".l_ordendecompra_anexopagos_" + resultados(0)) = False Then
'        Grid1.Cell(Grid1.Rows - 1, 7).text = ""
'        Else
'        Grid1.Cell(Grid1.Rows - 1, 7).text = "Rebajada En pago Pero No Generado el Pago"
'
'        End If
'
