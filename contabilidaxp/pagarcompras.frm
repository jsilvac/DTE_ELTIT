...
'             Grid1.Cell(linea, 4).text = leerdatos(contadb, "cuentascorrientes", "nombre", "rut='" + rutreal + "' and tipo='" + CUENTAPROVEEDOR + "' and año='" & Format(fechasistema, "yyyy") & "'")
...
Rcompra02.dato1.text = Grid1.Cell(Grid1.ActiveCell.row, 2).text
...
Public Function leefactura(tipo, numero, rut) As Boolean
    ...
    If tipo = "0" Then tipo2 = "EE"
    If tipo = "9" Then tipo2 = "EN"
    
    ABONO = leerabonofactura(tipo, tipo2, numero, rut, CUENTAPROVEEDOR, "D", sqlconta.response(4, 3))
...
Dim resultados As rdoResultset
    ...
    Dim pasada As String
        ...
        csql.sql = csql.sql + "FROM " + clientesistema + "gestion" + rubro + ".l_ordendecompra_detalle_facturas_" + localfiltro + " WHERE ordendecompra='" + ORDEN + "' and (tipo='FA' or tipo='FAE' or tipo='OE' or tipo='FC' or tipo='NCE' or tipo='FE' OR tipo='FEE' ) "
...
Sub GRABARCOMPROBANTE(ORDEN, montocheque, DIFERENCIA, fechacheque, TIPOPAGO, glosadiferencia)
    ...
    Dim csql As New rdoQuery
        ...
        If csql.RowsAffected > 0 Then
            ...
            If tipodocumento = "FE" Then tipo2 = "9": TIPO3 = "EN"
            If tipodocumento = "FEE" Then tipo2 = "0": TIPO3 = "EE"
    ...
    While Not resultados.EOF
        ...
        LINEAS = LINEAS + 1
         ...
         Dim numerosii As String
            ...
            Call grabarEspecialesguias(Grid1.Cell(LINEA, 2).text, LINEA, "11200044", "GUIA DEVO.ELEC. " & numerosii & " DEL " & Format(resultados(0), "dd-mm-yyyy"), resultados(2), "H", resultados(3), resultados(4), rutpro)
            End If
            If resultados(3) = "DM" Then
            Call grabarEspecialesguias(Grid1.Cell(LINEA, 2).text, LINEA, "11200044", "GUIA DEVOLUCION " & resultados(1) & " DEL " & Format(resultados(0), "dd-mm-yyyy"), resultados(2), "H", resultados(3), resultados(4), rutpro)
            End If
...
Public Sub grabarEspecialesguias(numero, LINEA, cuenta, glosa, monto, DH, TIPODO, numerodo, rutpro)
        Dim condicion As String
