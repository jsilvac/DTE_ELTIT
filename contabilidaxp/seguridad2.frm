...
Begin VB.Form moduloseguridad 
   ...
   Begin XPFrame.FrameXp FrameXp2 
      ...
      Begin XPFrame.FrameXp FrameXp5 
         ...
         EndProperty
         Alignment       =   1
         Begin VB.CommandButton CmdPermisosCuentas 
            BackColor       =   &H00FF8080&
...
Private Sub CmdPermisosCuentas_Click()
If USUARIOSELECCIONADO <> "" Then
Load PermisosCuentas
PermisosCuentas.Usuario = USUARIOSELECCIONADO

PermisosCuentas.Show 1
...
If MsgBox("ESTA SEGURO QUE DESEA ELIMINAR A " + Grid2.Cell(Grid2.ActiveCell.row, 1).text + " Y SUS PERMISOS", vbOKCancel, "ATENCION") = vbOK Then
        ...
        csql.sql = csql.sql + "where usuario='" + Grid2.Cell(Grid2.ActiveCell.row, 1).text + "' "
        csql.Execute
        Call sincronizadatos(cqsl.sql, conta, "")
...
Dim opcionmenu As Double
Dim opcionmenu2 As Double
...
contador2 = 0
opcionmenu = 0
Open App.path + "\index.php" For Output As 30
Print #30, "$menu = array "
Print #30, "("
...
opcionmenu = contador2
Print #30, Str(contador2) + " => array "
Print #30, "("

Print #30, "'text'     =>'" + varipaso + "',"
Print #30, "'class'     =>'" + varipaso + "',"
Print #30, "'link'     => '#',"
Print #30, "'show_condition'=>true,"
Print #30, "'parent'=>0"
Print #30, "),"
End If
If NIVELBANDERA = "1" Then
contador2 = contador2 + 1
opcionmenu2 = contador2
Print #30, Str(contador2) + " => array "
Print #30, "("
...
Print #30, "'link'     => '#',"
Print #30, "'show_condition'=>true,"
Print #30, "'parent'=>" & opcionmenu & ""
Print #30, "),"
End If
If NIVELBANDERA = "2" Then
contador2 = contador2 + 1
Print #30, Str(contador2) + " => array "
Print #30, "("
