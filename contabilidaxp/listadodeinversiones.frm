...
'        año = 2005
        ...
        csql.sql = "SELECT banco,empresa,tipo,numero,fechaemision,fechavencimiento,d_monto,d_tazaperiodo,d_interes,d_montoacobrar  "
        csql.sql = csql.sql + "FROM inver_movimientos  WHERE fechavencimiento>'" + Format(fechasistema, "yyyy-mm-dd") + "' order by banco,tipo,empresa "
        csql.Execute
        total = 0
        total2 = 0
