...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
        ...
        If fecha > "2012-12-31" Then
        csql2.sql = csql2.sql + "FROM " + clientesistema + "conta.sii_1847_2013 "
        Else
        csql2.sql = csql2.sql + "FROM " + clientesistema + "conta.sii_1847 "
        End If
