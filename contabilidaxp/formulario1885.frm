    ...
    fecha2 = año + "-" + MES + "-" + "31"
        ...
        Set resultados = csql.OpenResultset
         While Not resultados.EOF
             ...
             GRID1.Cell(linea, 2).text = leerdatos(db, "cuentascorrientes", "nombre", "rut='" + resultados(0) + "' and tipo='" + cuentahonorarios + "' ")
