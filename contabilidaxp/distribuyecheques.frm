...
Begin VB.Form banco05 
   ...
   Begin XPFrame.FrameXp FrameXp1 
      ...
      Begin XPFrame.FrameXp FrameQuickMenu 
         ...
         End
      End
      Begin VB.Label lblañodistribucion 
         BackColor       =   &H00FFFFFF&
         ...
         Width           =   840
      End
      Begin VB.Label lblmesdistribucion 
         BackColor       =   &H00FFFFFF&
         BackStyle       =   0  'Transparent
         BorderStyle     =   1  'Fixed Single
         BeginProperty Font 
         ...
         Width           =   375
      End
      Begin VB.Label lbldiadistribucion 
         BackColor       =   &H00FFFFFF&
         BackStyle       =   0  'Transparent
         BorderStyle     =   1  'Fixed Single
         BeginProperty Font 
...
Sub leercheque()
    ...
    If IsNull(sqlconta.response(10, 3)) = False Then
        lbldiadistribucion.Caption = Mid(sqlconta.response(10, 3), 1, 2)
        lblmesdistribucion.Caption = Mid(sqlconta.response(10, 3), 4, 2)
        lblañodistribucion.Caption = Mid(sqlconta.response(10, 3), 7, 4)
    End If
    ...
    If DATO5.text = "" Then DATO5.text = "0"
...
Sub leersiguiente()
    ...
    comprobante.Caption = sqlconta.response(5, 3)
    numero.Caption = sqlconta.response(6, 3)
    lbldiadistribucion.Caption = Mid(sqlconta.response(10, 3), 7, 2)
    lblmesdistribucion.Caption = Mid(sqlconta.response(10, 3), 5, 2)
    lblañodistribucion.Caption = Mid(sqlconta.response(10, 3), 1, 4)
...
Rem original GRILLATIPO.TextMatrix(7, 1) = "ENVIADO BUSES JAC"
GRILLATIPO.TextMatrix(7, 1) = "ENTREGADO A PERSONAL"
