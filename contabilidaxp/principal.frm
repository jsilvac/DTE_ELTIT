...
Begin VB.MDIForm PRINCIPAL 
   ...
   Begin VB.Menu ingreso 
      ...
      Begin VB.Menu bancos 
         ...
         End
         Begin VB.Menu banco 
            Caption         =   "SISTEMA AUTOMATICO DOLARES"
            Index           =   8
         End
         Begin VB.Menu banco 
      ...
      Begin VB.Menu proved 
         ...
         Index           =   99
         Begin VB.Menu prove 
            Caption         =   "Recepcion de Facturas de Compras"
            Index           =   1
         End
         Begin VB.Menu prove 
         ...
         End
         Begin VB.Menu prove 
            Caption         =   "Control de facturas Electronicas Recibidas en el SII "
            Index           =   12
         End
         Begin VB.Menu prove 
         ...
         End
         Begin VB.Menu prove 
            Caption         =   "revisor de Pago de Facturas Pago Duplicado"
            Index           =   14
         End
         Begin VB.Menu prove 
            Caption         =   "-"
         ...
         End
      End
      Begin VB.Menu provev 
         Caption         =   "MODULO FACTORING"
         Index           =   99
         Begin VB.Menu fac 
            Caption         =   "Pantalla Control de Facturas En Factoring"
            Index           =   1
         End
         Begin VB.Menu fac 
            Caption         =   "Pantalla Pago Factoring"
            Index           =   2
         End
      End
      Begin VB.Menu publi 
         ...
         End
         Begin VB.Menu publicidad 
            Caption         =   "Genera Facturacion Automatica"
            Index           =   11
         End
         Begin VB.Menu publicidad 
            Caption         =   "Prorroteo facturas de publicidad"
            Index           =   12
         End
      End
      Begin VB.Menu acti1 
   ...
   Begin VB.Menu procesos 
      ...
      End
      Begin VB.Menu proceso 
         Caption         =   "Contabiliza Pagos Inmobiliaria"
         Index           =   21
      End
      Begin VB.Menu proceso 
         Caption         =   "Contabiliza Moneda Extranjera"
         Index           =   22
      End
      Begin VB.Menu proceso 
         Caption         =   "Centraliza Pagos Seguro Complementario"
         Index           =   23
      End
      Begin VB.Menu proceso 
         Caption         =   "Centraliza Pagos Tarjeta eltit Plus"
         Index           =   24
      End
   End
   Begin VB.Menu info 
      ...
      Begin VB.Menu informesauxiliares 
         ...
         End
         Begin VB.Menu infoaux 
            Caption         =   "Lista Balance Tributario x Fecha"
            Index           =   12
         End
      End
      Begin VB.Menu informessii 
         ...
         End
         Begin VB.Menu infosii 
            Caption         =   "Formulario 1926 Base Imponible y Datos Contables"
            Index           =   6
         End
         Begin VB.Menu infosii 
      ...
      Begin VB.Menu infocontrol 
         ...
         End
         Begin VB.Menu infoco 
            Caption         =   "Lineas sin Codigo Para Form 3500"
            Index           =   8
         End
         Begin VB.Menu infoco 
            Caption         =   "Compara Libros"
            Index           =   9
         End
      End
      Begin VB.Menu bala 
   ...
   End
   Begin VB.Menu RCV 
      Caption         =   "REGISTRO COMPRA Y VENTA"
      Index           =   99
      Begin VB.Menu REGISTRO 
         Caption         =   "Compara Libro de Compras ERP v/s Libro  SII  (Genera Aceptacion)"
         Index           =   1
      End
      Begin VB.Menu REGISTRO 
         Caption         =   "Compara Libro SII v/s Libro de Compras ERP (Carga Archivos SII)"
         Index           =   2
      End
   End
...
Private Sub ACTI_Click(Index As Integer)
...
If Index = 1 Then activo01.Show: activo01.Caption = ACTIVOSII(Index).Caption
If Index = 2 Then activo02.Show: activo02.Caption = ACTIVOSII(Index).Caption
If Index = 3 Then activo03.Show: activo03.Caption = ACTIVOSII(Index).Caption
If Index = 4 Then activo04.Show: activo04.Caption = ACTIVOSII(Index).Caption
If Index = 5 Then activo05.Show: activo05.Caption = ACTIVOSII(Index).Caption
...
'
If Index = 8 Then banco09.Show: banco09.Caption = banco(Index).Caption

If Index = 9 Then banco07.Show: banco07.Caption = banco(Index).Caption
If Index = 10 Then Maestrocodigosbancarios.Show: Maestrocodigosbancarios.Caption = banco(Index).Caption
If Index = 11 Then poder_santander.Show: poder_santander.Caption = banco(Index).Caption
...
Private Sub fac_Click(Index As Integer)
    If Index = 1 Then factoring01.Show: factoring01.Caption = fac(Index).Caption
    If Index = 2 Then factoring02.Show: factoring02.Caption = fac(Index).Caption
...
If Index = 12 Then auxiliar09.Show
...
If Index = 8 Then control08.Show: control08.Caption = infoco(Index).Caption
If Index = 9 Then control09.Show: control09.Caption = infoco(Index).Caption
...
If Index = 5 And fechasistema < "2015-01-01" Then form1847.Show: form1847.Caption = infosii(Index).Caption
If Index = 5 And fechasistema > "2014-12-31" Then form1847_2016.Show: form1847_2016.Caption = infosii(Index).Caption
...
Private Sub MDIForm_Load()
 Call Conectar_BD
 If VerificaAplicacion("VB6.EXE") = False Then
...
If Index = 10 And Format(fechasistema, "yyyy") < "2015" Then ma1847.Show: ma1847.Caption = ingresos(Index).Caption
If Index = 10 And Format(fechasistema, "yyyy") > "2014" Then ma1847_2016.Show: ma1847_2016.Caption = ingresos(Index).Caption
...
If Index = 21 Then proceso21.Caption = PROCESO(Index).Caption: proceso21.Show
If Index = 22 Then proceso08.Caption = PROCESO(Index).Caption: proceso08.Show
If Index = 23 Then generabancopagoseguro.Caption = PROCESO(Index).Caption: generabancopagoseguro.Show
If Index = 24 Then generabancocreditosplus.Caption = PROCESO(Index).Caption: generabancocreditosplus.Show
...
If Index = 1 Then prove0014.Show: prove0014.Caption = prove(Index).Caption
If Index = 2 Then prove0001.Show: prove0001.Caption = prove(Index).Caption
If Index = 3 Then prove0003.Show: prove0003.Caption = prove(Index).Caption
If Index = 4 Then prove0002.Show: prove0002.Caption = prove(Index).Caption
If Index = 5 Then prove0004.Show: prove0004.Caption = prove(Index).Caption
If Index = 6 Then prove0005.Show: prove0005.Caption = prove(Index).Caption
If Index = 7 Then prove0006.Show: prove0006.Caption = prove(Index).Caption
If Index = 8 Then prove0007.Show: prove0007.Caption = prove(Index).Caption
If Index = 9 Then prove0008.Show: prove0008.Caption = prove(Index).Caption
If Index = 10 Then prove0009.Show: prove0009.Caption = prove(Index).Caption
If Index = 11 Then prove0010.Show: prove0010.Caption = prove(Index).Caption
If Index = 12 Then prove0011.Show: prove0011.Caption = prove(Index).Caption
If Index = 13 Then prove0012.Show: prove0012.Caption = prove(Index).Caption
If Index = 14 Then prove0013.Show: prove0013.Caption = prove(Index).Caption
If Index = 16 Then prove0009.Show: prove0009.Caption = prove(Index).Caption
If Index = 17 Then prove0016.Show: prove0016.Caption = prove(Index).Caption
...
If Index = 11 Then publi0011.Show: publi0011.Caption = publicidad(Index).Caption
If Index = 12 Then publi0012.Show: publi0012.Caption = publicidad(Index).Caption

Call grabaprincipal(publicidad(Index).Caption)

End Sub

Private Sub REGISTRO_Click(Index As Integer)
If Index = 1 Then compra01.Show: compra01.Caption = REGISTRO(Index).Caption
If Index = 2 Then compra02.Show: compra02.Caption = REGISTRO(Index).Caption
If Index = 3 Then compra03.Show: compra03.Caption = REGISTRO(Index).Caption
End Sub
