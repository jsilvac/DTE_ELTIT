...
Begin VB.Form generabancoanticiposquincena 
   BackColor       =   &H00FFC0C0&
   ...
   End
End
Attribute VB_Name = "generabancoanticiposquincena"
...
'        End If
 If GridLiquida.Cell(k, 9).text = "1" Then
        ...
        DH = "D"
  If verificasiexiste2(rutcontable, CUENTABANCO, FECHACONTABLE, tipocontable, "CANC. ANTICIPO ") = False Then

            lineacontable = lineacontable + 1
            Call grabarcomprobante_lineas(tipocontable, numerocontable, lineacontable, _
            FECHACONTABLE, CUENTABANCO, " ", rutcontable, " ", "CANC. ANTICIPO " & NOMBREGIRADO, _
