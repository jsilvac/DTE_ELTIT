...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
       totales = 0
        ...
        If resultados2(0) = "07" Then totales = 0
        End If
        If resultados2(0) = "15" Then
        Grid1.Cell(Grid1.Rows - 1, 4).text = totales2(7) - totales2(14)
        End If
        ...
        Grid1.Cell(Grid1.Rows - 1, 3).text = Format(leeripc("00", Format(fechasistema, "YYYY")), " % #.0")
        
        totales2(16) = totales2(15) * (leeripc("00", Format(fechasistema, "YYYY")) / 100)
        Grid1.Cell(Grid1.Rows - 1, 4).text = totales2(16)
        End If
...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
        ...
        Grid1.Cell(Grid1.Rows - 1, 4).text = leersaldomayor(resultados2(0), Format(fechasistema, "yyyy-mm-dd"))
...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
        ...
        Grid2.Cell(Grid2.Rows - 1, 3).text = leersaldomayor(resultados2(0), Format(fechasistema, "yyyy-mm-dd"))
...
titulo = "DETERMINACION CAPITAL PROPIO AL " + Format(fechasistema, "dd-mm-yyyy")
