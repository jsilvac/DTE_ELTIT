...
Begin VB.Form inver02 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Maestro Tipo de Inversion"
   ClientHeight    =   2865
   ClientLeft      =   2040
   ClientTop       =   1305
   ClientWidth     =   6285
...
Private Sub dato1_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = vbKeyF2 Then Call ayudatipodocumento(dato1)
...
Sub ayudatipodocumento(ByRef caja As TextBox)
    ...
    mensajeAyuda = "Ayuda codigo de Documentos"
