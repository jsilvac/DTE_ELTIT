...
Begin VB.Form libro_electro01 
   ...
   End
End
Attribute VB_Name = "libro_electro01"
...
Sub leecapital()
    ...
    Dim LINEAS As Double
       totales = 0
        ...
        csql2.sql = csql2.sql + "FROM plan_sii "
...
Dim resultados2 As rdoResultset
    ...
    Dim LINEAS As Double
        Set csql2.ActiveConnection = contadb
        csql2.sql = "SELECT codigo,nombre,plansii "
        csql2.sql = csql2.sql + "FROM cuentasdelmayor where año='" + AÑOCONSULTA + "' "
        csql2.sql = csql2.sql + "order by codigo"
        csql2.Execute
        LINEAS = 0
...
Private Sub Grid1_Click()
 If Grid2.Selection.FirstRow > 0 Then
        For k = Grid2.Selection.FirstRow To Grid2.Selection.LastRow
            ...
            Call modifica_mayor(Grid2.Cell(k, 1).text, Grid2.Cell(k, 3).text, "plansii")
