...
Begin VB.Form informa04 
   ...
   Begin TabDlg.SSTab sbtab1 
      ...
      TabPicture(0)   =   "listacartolasgenerales.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "opcion1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "CUENTAS CORRIENTES"
      TabPicture(1)   =   "listacartolasgenerales.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "opcion2"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "CENTROS DE COSTO"
      TabPicture(2)   =   "listacartolasgenerales.frx":0038
...
'    csql.sql = "SELECT fecha,tipo,numero,linea,codigocuenta,'CENTRALIZA COSTO VENTA',tipodocumento,numerodocumento,fechadocumento,fechavencimiento,SUM(IF(dh='d',monto,monto)),dh,centrocosto,tipoctacte,rutctacte FROM movimientoscontables WHERE codigocuenta='47100001' AND fecha>='2016-01-01' AND fecha<='2016-12-31' GROUP BY tipo,fecha,dh ORDER BY codigocuenta,fecha,tipo,numero,linea "
