...
Begin VB.Form generabancoaguinaldos 
   BackColor       =   &H00FFC0C0&
   ...
   End
End
Attribute VB_Name = "generabancoaguinaldos"
...
'        End If
 ...
 If GridLiquida.Cell(k, 9).text = "1" Then
        ...
        DH = "D"
          If verificasiexiste2(rutcontable, CUENTABANCO, FECHACONTABLE, tipocontable, "CANC. AGUINALDO ") = False Then

                lineacontable = lineacontable + 1
                Call grabarcomprobante_lineas(tipocontable, numerocontable, lineacontable, _
                FECHACONTABLE, CUENTABANCO, " ", rutcontable, " ", "CANC. AGUINALDO " & NOMBREGIRADO, _
...
Sub CargaGridLiquida(grilla As Grid)
    ...
    If csql.RowsAffected > 0 Then
        ...
        While Not resultados.EOF
             LIQUIDO = leeraquinaldos(resultados(0), Format(fechasistema, "mm"), Format(fechasistema, "YYYY"), "00010")
...
Sub grabarrevisado(MES, año, ruttrabajador, empresa, estado, fecha)
    ...
    Dim resultados As rdoResultset
    Set csql.ActiveConnection = contadb
    csql.sql = "delete from " & clientesistema & "remu.mt_fijo_revisa_aguinaldo "
...
'    Call sincronizadatos(csql.sql, contadb, "")
    ...
    csql.sql = "insert into " & clientesistema & "remu.mt_fijo_revisa_aguinaldo (empresa,año,mes,ruttrabajador,estado,fecha)"
...
Function leerestado(empresaconsulta, MES, año, ruttrabajador) As String
    ...
    csql.sql = csql.sql & "from " & clientesistema & "remu.mt_fijo_revisa_aguinaldo "
...
'leer
MsgBox "COMPROBANTE AG N°" & numerocontable & " GENERADO EXITASAMENTE ", vbInformation, "ATENCION"
