...
Begin VB.Form revisacompras 
   BackColor       =   &H00FF8080&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Revisa Factura de Compra"
   ClientHeight    =   7950
   ClientLeft      =   45
   ClientTop       =   1110
   ClientWidth     =   14295
   ...
   Begin XPFrame.FrameXp FrameXp1 
      ...
      _ExtentY        =   13917
      BackColor       =   8454016
      Caption         =   "REVISA LIBRO DE COMPRAS"
      CaptionEstilo3D =   1
      BackColor       =   8454016
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
   ...
   End
End
Attribute VB_Name = "revisacompras"
...
Sub Command1_Click()
        ...
        Dim resultados As rdoResultset
            Dim csql As New rdoQuery
                ...
                csql.sql = csql.sql + "where fc.rut=cc.rut and cc.año='" + COMBOAÑO.text + "' and cc.tipo='" + CUENTAPROVEEDOR + "' and fc.mescontable='" + Format(fechasistema, "mm") + "' and fc.añocontable='" + Format(fechasistema, "yyyy") + "' "
                'cSql.SQL = cSql.SQL + "AND fc.numero='0001326204' order by tipo,fecha "
        '        csql.sql = csql.sql & "AND fc.tipo='8' "
...
Dim resultados As rdoResultset
    Dim csql As New rdoQuery
        ...
        Set csql.ActiveConnection = contadb
'        csql.sql = "delete from  movimientoscontables where (TIPO='FC' OR TIPO='ND' OR TIPO='NC' OR TIPO= 'FP') "
        csql.sql = "delete from  movimientoscontables where (TIPO='FC' OR TIPO='DC' OR TIPO='NC' OR TIPO= 'FP' OR TIPO='IM' OR TIPO='EN' OR TIPO='EE' ) "
        csql.sql = csql.sql + " and mes='" + Format(fechasistema, "mm") + "' and año='" + Format(fechasistema, "yyyy") + "' "
...
If Val(dato1.text) < 0 Or Val(dato1.text) > 10 Then dato1.Enabled = True: dato1.text = "": dato1.SetFocus
End Sub
...
For k = 1 To 2
mesante = mesante - 1
If mesante = 0 Then mesante = 1: AÑOANTE = AÑOANTE - 1
Next k
...
Sub grabafactura()
    ...
    campos(18, 1) = iva_no_recuperable.Value
...
Sub ELIMINAR()
    ...
    If dato1.text = "0" Then TIPOCON = "EN"
    If dato1.text = "9" Then TIPOCON = "EE"
