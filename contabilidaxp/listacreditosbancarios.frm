...
Begin VB.Form prestamo03 
   ...
   Begin XPFrame.FrameXp FrameXp3 
      ...
      _ExtentY        =   15425
      BackColor       =   16761024
      Caption         =   "Vencimientos Creditos Bancarios"
      CaptionEstilo3D =   1
      BackColor       =   16761024
      ForeColor       =   65535
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
...
Sub CARGAGRILLA2()
 ...
 csql.sql = csql.sql + "where datediff(cv.fecha,'" + Format(fechasistema, "yyyy-mm-dd") + "')<45 and cv.pagado='0' "
