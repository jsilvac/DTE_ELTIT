...
'============================================================
    ...
    Private Sub dato3_KeyDown(KeyCode As Integer, Shift As Integer)
        Call flechas(dato3, dato3, KeyCode)
    End Sub
...
'=============================================================================
    Private Function leerUsuario(ByVal operador As String) As Boolean
        ...
        If sqlconta.status = 0 Then
            ...
            CLAVE = sqlconta.response(1, 3)
            lblNOMBRE.Caption = sqlconta.response(2, 3)
            lbllabor.Caption = sqlconta.response(3, 3)
            lblmail.Caption = sqlconta.response(4, 3)
        Else
            leerUsuario = False
        End If
    End Function
