...
Begin VB.Form ayudamaestrodesecciones 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda Maestro de Secciones"
   ClientHeight    =   6930
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9900
   ...
   Begin MSAdodcLib.Adodc msecciones 
      Height          =   375
      Left            =   840
      Top             =   5160
      Visible         =   0   'False
   ...
   Begin VB.Frame datospersonales 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "ayudamaestrodesecciones.frx":0000
         Height          =   4935
         Left            =   120
         TabIndex        =   2
         Top             =   600
      ...
      Begin VB.Label Label1 
         BackStyle       =   0  'Transparent
         Caption         =   "Buscar por Nombre de Seccion"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ayudamaestrodesecciones"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub buscaproductos_Change()
With ayudamaestrodesecciones
        .msecciones.ConnectionString = "driver={MySQL ODBC 3.51 Driver};" & _
        "server=localhost;uid=root;pwd=;database=conta01"
        .msecciones.RecordSource = "SELECT codigoseccion, nombre FROM maestrosecciones WHERE nombre >= '" & buscaproductos.text & "' ORDER BY nombre"
        .msecciones.Refresh
    End With
    ' <>
End Sub
